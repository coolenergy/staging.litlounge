...
import { payoutRequestService, studioService } from 'src/services';
...
class StudiosPayoutRequestPage extends PureComponent<IProps, IStates> {
...
export default StudiosPayoutRequestPage;
